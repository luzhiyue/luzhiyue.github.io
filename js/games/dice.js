;(function () {
  ...
  if (window.diceGameInstance) {
    document
      ...
      ?.removeEventListener('click', window.diceGameInstance.handleRoll)
    window.diceGameInstance = null
  }
  ...
  class DiceGame {
    constructor() {
      ...
      this.lastResults = [1, 1, 1]

      // 绑定方法到实例
      this.handleRoll = this.rollAllDice.bind(this)
