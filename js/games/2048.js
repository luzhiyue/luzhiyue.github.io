;(function () {
  // 如果已经存在实例，先销毁
  if (window.game2048Instance) {
    document.removeEventListener('keydown', window.game2048Instance.handleKeydown)
    document
      .getElementById('start-btn')
      ?.removeEventListener('click', window.game2048Instance.handleStart)
    document
      .getElementById('undo-btn')
      ?.removeEventListener('click', window.game2048Instance.handleUndo)
    window.game2048Instance = null
  }
  ...
  class Game2048 {
    constructor() {
      ...
      this.handleStart = this.init.bind(this)
      this.handleUndo = this.undo.bind(this)
  ...
  // 创建新实例并保存到window对象
  window.game2048Instance = new Game2048()
})()
